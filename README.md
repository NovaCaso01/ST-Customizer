...
- 다양한 프리셋 아이콘 제공 (픽셀, 블랙, 큐트, 이모지 하트 등)
...
- **GIF 스타일**: 산리오, 고양이, 토끼, 판다, 피카츄 등 20종 이상
...
### v1.1.0
**기능 추가 및 개선**
- 🏷️ 탭 타이틀 커스터마이징 기능 추가 (16종 프리셋)
- 🔔 알림음 프리셋 5종 추가
- 🎨 라벤더 테마 UI 전면 리디자인
- 🛡️ CSS 격리 강화 (확장 스타일 ↔ ST 테마 간 간섭 방지)
- 🖼️ 파비콘 프리셋 대폭 확장 (블랙, 큐트, 이모지 하트 등)
- ✨ 타이핑 인디케이터 GIF 스타일 다수 추가
- ⌨️ 타이핑 효과 (타자기 효과) ON/OFF 지원
- 🔤 12종 한글 웹폰트 선택 지원
